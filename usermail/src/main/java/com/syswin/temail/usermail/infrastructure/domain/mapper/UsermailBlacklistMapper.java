...
public interface UsermailBlacklistMapper {
   ...
   * @return 插入的数量
   */
  int insert(UsermailBlacklistDO usermailBlacklist);
   ...
   * @return 删除的数量
   */
  int deleteByAddresses(UsermailBlacklistDO usermailBlacklist);
   ...
   * @return 黑名单信息
   */
  UsermailBlacklistDO selectByAddresses(@Param("temailAddress") String temailAddress, @Param("blackedAddress") String blackedAddress);
   ...
   * @return 黑名单列表
   */
  List<UsermailBlacklistDO> selectByTemailAddress(String temailAddress);
